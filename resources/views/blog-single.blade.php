...
@section('content')
    <div class="col-md-12 col-lg-8 main-content">
        ...
        <h2 class="mb-4">How to get the Best Performance of Teamwork</h2>
        <a class="category mb-5" href="{{asset('/category.php')}}">Food</a> <a class="category mb-5" href="{{asset('/category.php')}}">Travel</a>
        <img src="{{asset('/images/img_10.jpg')}}" alt="Image" class="img-fluid mb-5">
        ...
        <div class="pt-5">
            <p> Categories:     <a href="{{asset('/category.php')}}">Food</a>,
                                <a href="{{asset('/category.php')}}">Travel</a>
                Tags:           <a href="{{asset('/tag.php')}}">#manila</a>,
                                <a href="{{asset('/tag.php')}}">#asia</a></p>
        </div>
