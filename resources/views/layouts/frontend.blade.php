    ...
    <div class="container">
        ...
        <!-- END main-content -->
            ...
            <div class="col-md-12 col-lg-4 sidebar">
                ...
                @foreach($adminUser as $admin)
                    <div class="sidebar-box">
                        <div class="bio text-center">
                            ...
                            <div class="bio-body">
                                <a href="{{asset('/about')}}"><h2>{{$admin->name}}</h2></a>
                                <p>
                                ...
                                <p>
                                    <a href="{{asset('/about')}}" class="btn btn-primary btn-sm rounded">
                                        Read my bio
                                    </a>
                                </p>
                                <p class="social">
                    ...
                    <div class="post-entry-sidebar">
                        <ul>
                            @foreach($lsPopular as $popular)
                                <li>
                                    <a class="post-entry-link" href="{{asset('/view_post/'.$popular->id)}}">
                                        <img src="{{asset($popular->cover)}}" alt="Image placeholder">
                ...
                <!-- END sidebar-box -->
                <div class="sidebar-box">
                    <h3 class="heading"><i class="fas fa-rss-square"></i> Don't know what to read?</h3>
                    <form class="text-center" method="get" action="{{asset('/randomPost')}}">
                        @csrf
                        <input style="width: 100%" class="btn btn-primary" value="Get Random Post" type="submit">
                    </form>
                </div>
                <div class="sidebar-box">
                ...
                <div class="post-entry-sidebar">
                    <ul>
                        @foreach($lsLatest as $latest)
                            <li>
                                <a class="post-entry-link" href="{{asset('/view_post/'.$latest->id)}}">
                                    <img src="{{asset($latest->cover)}}" alt="Image placeholder" class="mr-2">
                                    <div class="text">
                                        <h4>{{$latest->title}}</h4>
                                        <div class="post-meta">
                                            ...
                                            &bullet;
                                            <span class="ml-sm-2"><span class="fa fa-comments"></span>
                ...
                <div class="row">
                    <div class="col-6 col-sm-3 col-lg-6 mt-sm-2 mt-lg-0 text-center">
                        ...
                        <ul class="list-unstyled">
                            ...
                            @endforeach
                            <li><a href="{{asset('/contact')}}"><i class="fa fa-comment-dots"></i> Contact Me</a></li>
                        </ul>
                    </div>
                    <div class="col-6 d-sm-none d-lg-block col-sm-3 col-lg-6 mt-sm-2 mt-lg-0 text-center">
                        ...
                        <ul class="list-unstyled footer-social">
                            <li><a href="https://twitter.com/"><span class="fab fa-twitter"></span> Twitter</a></li>
                            <li><a href="https://www.facebook.com/"><span class="fab fa-facebook-square"></span>
                                    Facebook</a></li>
                            <li><a href="https://www.instagram.com/"><span class="fab fa-instagram"></span>
                                    Instagram</a></li>
                            <li><a href="https://www.youtube.com/"><span class="fab fa-youtube"></span> Youtube</a></li>
                            <li><a href="https://www.snapchat.com/"><span class="fab fa-snapchat-square"></span>
                                    Snapshot</a></li>
                        </ul>
                    </div>
